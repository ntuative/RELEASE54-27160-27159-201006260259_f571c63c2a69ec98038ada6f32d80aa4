package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_767:Number = 0.71;
      ...
      private var var_1210:HabboTracking;
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_767 + var_30.getNumberOfFilesLoaded() / _loc11_ * const_767;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function prepareCore() : void
      {
         ...
         var_1210 = HabboTracking.getInstance();
         ...
         if(var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               if(_loc4_.fileName == "hh_human_fx.swf" || _loc4_.fileName == "hh_human_body.swf")
               {
                  if(var_1210 && true)
                  {
                     var_1210.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_941,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_23);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_941,error);
            Core.dispose();
         }
      }
