package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_11:String = "client.init.swf.error";
      ...
      {
         trackLoginStep(const_11);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_8,const_7,null);
      }
