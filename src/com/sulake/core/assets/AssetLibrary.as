package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1194:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_687:uint = 0;
      
      public static const const_735:String = "AssetLibraryReady";
      
      public static const const_1298:String = "AssetLibraryUnloaded";
      
      public static const const_469:String = "AssetLibraryLoaded";
      
      public static const const_1352:String = "AssetLibraryLoadError";
       
      
      private var var_582:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_687;
         var_475 = new Dictionary(false);
         var_476 = new Dictionary(false);
         var_833 = new Dictionary(false);
         var_151 = new Dictionary(false);
         var_1194.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_475)
         {
            _loc4_ = AssetTypeDeclaration(var_475[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = var_476[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_476[_loc1_];
         }
         for(_loc1_ in var_151)
         {
            delete var_151[_loc1_];
         }
         for(_loc1_ in var_833)
         {
            delete var_833[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
         ...
         var_341 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1298));
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in var_151)
         {
            _loc3_ = var_151[_loc2_];
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_582 = _loc2_.manifest.copy();
         var_393 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_583)
         {
            AssetLibrary.fetchLibraryContents(this,var_582,var_393);
         }
         var_341 = true;
         dispatchEvent(new Event(AssetLibrary.const_469));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_476[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1036,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_962,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1017,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_939,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_476[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_475.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_475[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1194.splice(var_1194.indexOf(this),1);
            --var_687;
            var_476 = null;
            var_833 = null;
            var_151 = null;
      ...
      {
         return param1 < var_392.length ? getAssetByName(var_392[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1352));
         var_17 = null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_151)
         {
            if(var_151[_loc2_] == param1)
            {
               return var_392.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_475)
         {
            _loc3_ = AssetTypeDeclaration(var_475[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_833[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_582.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_393[param1]);
      ...
      {
         var _loc2_:IAsset = var_151[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_476[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++var_223;
                     var_392.push(struct.assetName);
                  }
                  var_151[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_39,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_151)
            {
               if(var_151[_loc2_] == param1)
               {
                  var_392.splice(var_392.indexOf(_loc2_),1);
                  delete var_151[_loc2_];
                  --var_223;
                  return param1;
               }
            }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_475[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_393 != null ? false : false;
      }
   }
}
