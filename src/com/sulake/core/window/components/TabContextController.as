package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1107:String = "_CONTENT";
      
      private static const const_1106:String = "_SELECTOR";
       
      
      private var var_1438:Boolean = false;
      
      protected var var_1027:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1726 == null)
         {
            var_1726 = findChildByTag(const_1107) as IWindowContainer;
         }
         return var_1726;
      }
      ...
      {
         return var_1027.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1027 == null)
         {
            var_1027 = findChildByTag(const_1106) as ITabSelectorWindow;
            if(var_1027 != null)
            {
               var_1027.procedure = selectorEventProc;
            }
         }
         return var_1027;
      }
      ...
      {
         return !!var_921 ? selector.iterator : null;
      }
      
      public function method_10(param1:String) : ITabButtonWindow
      {
