package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_805:String = "margin_top";
      
      private static const const_1129:String = "_SCALER";
      
      private static const const_802:String = "margin_right";
      
      private static const const_1127:String = "_HEADER";
      
      private static const const_1113:String = "_TITLE";
      
      private static const const_1128:String = "_CONTENT";
      
      private static const const_803:String = "margin_left";
      
      private static const const_804:String = "margin_bottom";
      ...
      private var var_1358:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_803,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_805,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_802,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_804,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1056,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_267);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_192);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1358 == null)
         {
            var_1358 = findChildByTag(const_1127) as IHeaderWindow;
            if(!var_1358)
            {
      ...
      {
         return findChildByTag(const_1129) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_287,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1128) as IWindowContainer;
            if(!var_22)
            {
