package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1168:String = "increment";
      
      private static const const_522:String = "slider_bar";
      
      private static const const_1169:String = "decrement";
      
      private static const const_824:String = "slider_track";
      ...
      protected var var_839:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_173 = false;
         var_23 = param12;
         _horizontal = param2 == WindowType.const_475;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_522:
      ...
      {
         return findChildByName(const_824) as WindowController;
      }
      ...
      {
         return track.findChildByName(const_522) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_995 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_995 != null)
         {
            _loc1_ = findParentByName(var_995) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_995) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            else if(param2.name == const_1169)
            {
               if(var_23)
               {
                  var_678 = true;
            ...
            else if(param2.name == const_824)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_522).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_882)
         {
