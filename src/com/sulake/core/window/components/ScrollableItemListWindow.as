package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_950:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_382)
         {
            var_382 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_382)
            {
               var_382.addEventListener(WindowEvent.const_253,scrollBarEventProc);
               var_382.addEventListener(WindowEvent.const_217,scrollBarEventProc);
            }
         }
         return var_382;
      }
      ...
      override public function dispose() : void
      {
         if(var_382)
         {
            var_382.removeEventListener(WindowEvent.const_253,scrollBarEventProc);
            var_382.removeEventListener(WindowEvent.const_217,scrollBarEventProc);
            var_382 = null;
         }
         if(var_950)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_217)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_950)
         {
            var_950 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_950;
      }
