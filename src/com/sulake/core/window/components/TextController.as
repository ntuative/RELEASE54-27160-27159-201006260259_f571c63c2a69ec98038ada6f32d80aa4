package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_587:String = "none";
      
      protected var var_689:Number;
      
      protected var var_395:Number;
      
      protected var _field:TextField;
      
      protected var var_836:Boolean = false;
      ...
      {
         return new Rectangle(var_689 * maxScrollH,var_395 * maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_224)
         {
            if(param2.type == WindowNotifyEvent.const_158)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1053,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_504,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_53,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_53,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_504,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_53,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_53,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_53,true));
         ...
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_53,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_53,true));
         ...
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_53,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_587,PropertyStruct.STRING,var_587 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_53,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_53,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_53,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_53,_field.defaultTextFormat.kerning != false));
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_395 = var_395;
         _loc1_.var_71 = var_71.clone(_loc1_.setTextMargins);
         _loc1_.var_587 = var_587;
         _loc1_.var_836 = var_836;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_587 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_587 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_587 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_587 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
