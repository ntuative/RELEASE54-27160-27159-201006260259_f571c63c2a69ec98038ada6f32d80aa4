package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1566:String = "_INCLUDE";
      
      public static const const_990:String = "_EXCLUDE";
      ...
      protected var var_1201:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_1022:Dictionary;
      
      protected var var_1484:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1485:Dictionary;
      
      protected var var_1200:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1201 = new Dictionary();
         TypeCodeTable.fillTables(var_1200,var_1201);
         var_1022 = new Dictionary();
         var_1485 = new Dictionary();
         ParamCodeTable.fillTables(var_1022,var_1485);
         var_1484 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1200)
            {
               delete var_1200[_loc1_];
            }
            for(_loc1_ in var_1201)
            {
               delete var_1201[_loc1_];
            }
            for(_loc1_ in var_1022)
            {
               delete var_1022[_loc1_];
            }
            for(_loc1_ in var_1485)
            {
               delete var_1485[_loc1_];
            }
            var_1484.dispose();
            var_1484 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_990) == -1)
                  {
