package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_1949:Dictionary;
      ...
      private var var_1950:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1950 = new Dictionary();
         TypeCodeTable.fillTables(var_1560,var_1950);
         var_1298 = new Dictionary();
         var_1949 = new Dictionary();
         StateCodeTable.fillTables(var_1298,var_1949);
         ...
         {
            var_399 = new Array();
            var_399.push(WindowState.const_64);
            var_399.push(WindowState.const_70);
            var_399.push(WindowState.const_93);
            var_399.push(WindowState.WINDOW_STATE_SELECTED);
            var_399.push(WindowState.const_80);
            var_399.push(WindowState.const_76);
            var_399.push(WindowState.const_94);
            var_399.push(WindowState.const_86);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1298)
         {
            _loc3_.push(var_1298[_loc4_]);
         }
         if(param1 != null)
         {
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_738[param1] = new Array(SkinContainer.const_786);
         }
         var_738[param1][param2] = param3;
         if(true)
         {
            var_737[param1] = new Array(SkinContainer.const_786);
         }
