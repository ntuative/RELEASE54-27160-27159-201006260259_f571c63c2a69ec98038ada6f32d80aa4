package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_276:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(var_177 != null)
         {
            while(false)
            {
               _loc1_ = var_177[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_177.length > param1)
         {
            _loc2_ = var_177["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
