package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_144:IRoomRendererBase;
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_253.getValue(_loc2_) != null)
         {
            _loc3_ = var_253.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_253 != null)
         {
            ...
            {
               _loc3_ = var_253.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_144)
               {
                  var_144.removeRoomObject(_loc4_.getInstanceId());
               }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_253.getValue(_loc2_) != null)
         {
            return var_253.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_253.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_253.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_144)
                  {
                     var_144.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
