package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function RoomObjectLocationCacheItem(param1:String)
      {
         ...
         var_301 = new Vector3d();
      }
      
      public function needsUpdate(param1:int, param2:int) : Boolean
      {
         if(param1 != var_1446 || param2 != var_2393)
         {
            var_1446 = param1;
            var_2393 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_301 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_301.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_301.x = Math.round(var_301.x);
            var_301.y = Math.round(var_301.y);
         }
         return var_301;
      }
