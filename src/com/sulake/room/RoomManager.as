package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_675:int = -1;
      ...
      private var var_505:IRoomObjectFactory = null;
      
      private var var_1048:int;
      
      private var var_2524:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_507 = [];
         var_506 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_330,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_491,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_584,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_37 == const_1239)
         {
            if(var_862 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_505.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_505 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_506.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = var_110.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_110 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_110.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc2_:IRoomInstance = var_110.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_505 != null)
         {
            return var_505.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_110.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         return var_110.getValue(param1) as IRoomInstance;
      }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         while(_loc6_ >= 0)
         {
            _loc7_ = var_110.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = var_110.getKey(_loc6_);
            if(_loc7_ != null)
            {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_505.createRoomObjectLogic(_loc18_);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var_110.add(String(param1),_loc3_);
         var _loc4_:int = -1;
         while(_loc4_ >= 0)
         {
            _loc5_ = 0;
