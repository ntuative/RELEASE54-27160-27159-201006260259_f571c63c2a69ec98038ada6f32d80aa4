package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_579:Number = 64;
      
      public static const const_836:Number = 32;
      ...
      private var var_1670:Number = 1.0;
      ...
      private var var_1669:Number = 1.0;
      
      private var var_2509:Number = 500.0;
      
      private var var_1671:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_92 = new Vector3d();
         var_1170 = new Vector3d();
         var_1670 = 1;
         var_1671 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1669 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_465 != param1 * var_1669)
         {
            var_465 = param1 * var_1669;
            ++var_80;
         }
      }
      ...
      {
         if(var_463 != param1 * var_1670)
         {
            var_463 = param1 * var_1670;
            ++var_80;
         }
      }
      ...
      {
         if(var_464 != param1 * var_1671)
         {
            var_464 = param1 * var_1671;
            ++var_80;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_462 != null)
         {
            ...
            var_462.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_462.add(_loc3_,_loc4_);
            ++var_80;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1170.assign(_loc22_);
         }
         else
         {
            var_1170.assign(_loc17_);
         }
         ++var_80;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_464;
         _loc2_.z *= var_465;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1170);
         if(_loc3_ < var_2510 || _loc3_ > var_2509)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_464;
            _loc2_.z *= var_465;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1170);
         }
      ...
      {
         return new Vector3d(0 * var_463,0 * var_464,0 * var_465);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_462 != null)
         {
            ...
            return var_462.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_463,0 * var_464,0 * var_465);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_92;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_463,param2.y * var_464,param2.z * var_465);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_463,param3.y * var_464,param3.z * var_465);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_463,param4.y * var_464,param4.z * var_465);
