package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1152:UserDataManager;
      ...
      {
         if(var_37 == RoomSessionEvent.const_342 && _connection != null)
         {
            var_37 = RoomSessionEvent.const_90;
            if(isPrivateRoom)
            {
      ...
      public function method_8(param1:String, param2:String) : void
      {
      ...
      {
         return var_1152 as IUserDataManager;
      }
