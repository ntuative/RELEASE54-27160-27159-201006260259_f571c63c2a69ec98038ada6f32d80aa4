package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1536:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_299:ToolbarBarMenuAnimator;
      
      private var var_1537:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_200 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_52,HabboWindowStyle.const_926,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1073 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1073)
         {
         ...
         var_1272 = _loc7_.toolbar.@margin_bottom;
         var_1536 = _loc7_.toolbar.@min_group_margin;
         var_1537 = _loc7_.toolbar.@margin_to_extrabar;
         var_299 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_268,param1,param2,_window,var_299);
         createGroupsFromXmlList(_loc9_,var_619,param1,param2,var_200,var_299);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_131,var_513,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1536,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1272) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1536,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1272) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_131,var_513);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_268.length)
         {
            _loc2_ = var_268[_loc3_];
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_513);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_131,var_513);
         }
      }
