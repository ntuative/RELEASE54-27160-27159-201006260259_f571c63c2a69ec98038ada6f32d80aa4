   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_1000.push(new XML());
               var_999.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_999[var_56] = param6.clone();
         }
      ...
      {
         if(var_1468 == true || var_822 == 0)
         {
            if(false)
            {
               ++var_56;
               if(var_56 >= var_1000.length)
               {
                  var_56 = 0;
                  ++var_822;
               }
      ...
      {
         return var_1468 == false && var_822 == 1 && var_1322 != var_37;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_56 <= var_999.length)
         {
            _loc2_ = var_999[var_56];
