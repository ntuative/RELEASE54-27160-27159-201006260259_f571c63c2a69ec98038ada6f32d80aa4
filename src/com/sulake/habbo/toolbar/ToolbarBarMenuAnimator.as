package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1176:Number = 90;
      
      private static const const_789:int = 50;
      
      private static const const_1104:Number = 25;
      
      private static const const_1103:int = 50;
      
      private static const const_183:Boolean = true;
       
      
      private var var_638:Timer;
      
      private var var_1094:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1094 = param2;
         var_638 = new Timer(const_1104);
         var_638.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_532.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_532.splice(_loc3_,1);
            var_531.splice(_loc3_,1);
         }
         var_531.push(param1.name);
         var_532.push(param2);
         param1.addEventListener(WindowEvent.const_397,windowEventListener);
         param1.addEventListener(WindowEvent.const_217,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_532[var_531.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1094.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_318.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_318.splice(var_318.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1094.getIconLoc(param1.iconId);
      ...
      {
         return var_531[var_532.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_318[_loc1_],true);
            _loc1_++;
         }
      }
      
      private function method_2(param1:MenuAnimatorItem) : Point
      {
         var _loc8_:int = 0;
         var _loc9_:* = null;
         var _loc10_:* = null;
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_637[_loc3_] = new Array();
            }
            if(var_637[_loc3_].indexOf(param1) < 0)
            {
               var_637[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_789 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_789 || param1.desktop.height - param1.y < const_1103;
      }
      ...
      public function repositionWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc5_:Point = method_2(_loc3_);
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_531[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_637[_loc3_].length)
                  {
                     repositionWindow(var_637[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         var _loc9_:Point = method_2(_loc8_);
         if(_loc9_ != null)
         {
      ...
      public function positionWindow(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:Array = null) : void
      {
         ...
         var _loc8_:Point = method_2(_loc7_);
         if(_loc8_ != null)
         {
            _loc7_.target = null;
            param3.x = _loc8_.x;
