package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_250 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_250.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_250 is FloorItem ? 1 : 2;
         var_2265 = _loc2_;
         var_2263 = var_250.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_250.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1695,var_1694);
         }
      }
      ...
      {
         if(param1 != var_2265 || param2 != var_2263)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1792);
      }
      ...
      {
         if(_controller != null && false && var_250 != null)
         {
            _controller.furniModel.removeLockFrom(var_250.id);
            var_250 = null;
         }
      }
