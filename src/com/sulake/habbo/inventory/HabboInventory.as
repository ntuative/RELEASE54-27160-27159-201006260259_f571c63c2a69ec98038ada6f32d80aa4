package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_858:IRoomSession;
      ...
      private const const_1724:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_21 != null)
         {
            var_21.events.removeEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
            var_21.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_454,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_107:
               var_858 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_454:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_665));
      }
      ...
      {
         return PetsModel(var_48.getValue(InventoryCategory.const_150));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1034));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1724);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_335));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_255:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_857.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_857.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_255));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_375 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_857.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_48.getValue(InventoryCategory.const_318) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1058 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_269));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
         var_21.events.addEventListener(RoomSessionPropertyUpdateEvent.const_454,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_318,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_375);
         var_48.add(InventoryCategory.const_269,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_665,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_375);
         var_48.add(InventoryCategory.const_335,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_255,_loc8_);
         ...
         var_48.add(InventoryCategory.const_150,_loc10_);
