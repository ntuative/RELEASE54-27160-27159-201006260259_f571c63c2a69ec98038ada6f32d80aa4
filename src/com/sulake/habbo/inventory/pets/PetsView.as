package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_310:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_552 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_613 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_613.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_310 != null)
         {
            var_310.setSelected(false);
         }
         var_310 = param1;
         if(var_310 != null)
         {
            var_310.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_310.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_613.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_552.removeGridItem(_loc2_.window);
         if(var_310 == _loc2_)
         {
            var_310 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_613.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_552.addGridItem(_loc2_.window);
            var_613.add(param1.id,_loc2_);
            if(var_310 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_46,this);
            if(_loc13_ == null)
            {
               return;
            }
