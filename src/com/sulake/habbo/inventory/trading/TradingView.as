package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_796:uint = 4284532064;
      
      private static const const_797:uint = 2577770;
      ...
      private var var_368:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_368 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_170)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_863)
            {
            ...
            var_368.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_436);
            var_368.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1589 == null)
         {
            var_1589 = createMinimizedWindow();
         }
         if(!var_2017)
         {
            return var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_796) : uint(const_797);
            }
         ...
         if(var_66)
         {
            ...
            switch(var_24.state)
            {
               ...
               case TradingModel.const_268:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_483:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_231:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
