package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_483:uint = 4;
      ...
      public static const const_1272:uint = 9;
      
      public static const const_231:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_504 = false;
         var_714 = false;
         var_49.updateItemList(var_715);
         var_49.updateItemList(var_1264);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_49.alertPopup(TradingView.const_838);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_715)
            {
               var_504 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_714 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_715)
            {
               var_49.alertPopup(TradingView.const_830);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_37 + " NEW STATE: " + param1 + " OWN: " + var_504 + " OTHER: " + var_714);
         ...
         {
            case const_179:
               if(param1 == const_180 || param1 == const_231)
               {
                  var_37 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(var_233 == null || false)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_233.length)
         {
            _loc2_ = var_233.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_233.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_675)
         {
            if(var_37 != const_179 && var_37 != const_231)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_179;
            var_14.toggleInventorySubPage(InventorySubCategory.const_1045);
            var_675 = false;
         }
         var_49.setMinimized(false);
      }
