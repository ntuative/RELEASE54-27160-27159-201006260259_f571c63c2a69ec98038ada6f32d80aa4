package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2467:IWindowContainer;
      ...
      private var var_926:Boolean = true;
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_759 == InventoryCategory.const_150)
            {
               toggleCategoryView(InventoryCategory.const_150);
            }
            else if(var_759 == InventoryCategory.const_75)
            {
               toggleCategoryView(InventoryCategory.const_75);
            }
            else if(_controller != null)
            {
               _controller.toggleInventoryPage(InventoryCategory.const_75);
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_742,HabboToolbarIconEnum.INVENTORY,var_18 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         _controller.inventoryViewOpened(var_758);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_759 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(_toolbar != null && var_926)
