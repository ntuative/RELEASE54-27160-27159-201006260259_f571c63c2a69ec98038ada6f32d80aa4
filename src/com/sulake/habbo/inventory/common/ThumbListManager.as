package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1036:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_593 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_593.width;
         var_97 = var_593.height;
         var_1037 = param5;
         var_841 = param6;
         var_226 = Math.floor(var_1037 / _thumbWidth);
         var_20 = new BitmapData(var_1037,var_841);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_20.height < var_841)
         {
            _loc12_ = new BitmapData(var_20.width,var_841);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_593.width,var_593.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_593.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_593,var_593.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1036 != null)
         {
            _loc1_ = var_1036.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_486 = resolveRowCountFromList();
         if(var_486 == 0)
         {
            var_20 = new BitmapData(var_1037,var_841);
            return;
         }
         var_20 = new BitmapData(Math.max(var_226 * _thumbWidth,var_1037),Math.max(var_486 * var_97,var_841),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_486)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_226 && var_20.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_226 - 1),var_97);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_226 - 1),0,_thumbWidth,var_20.height);
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_226 - 1),0 - var_97);
