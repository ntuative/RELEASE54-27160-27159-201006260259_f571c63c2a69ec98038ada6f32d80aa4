package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2420:BitmapData;
      ...
      private const const_1723:int = 8947848;
      ...
      private const const_1459:Number = 0.2;
      
      protected var var_1486:Boolean;
      
      private const const_1458:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_736)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1699));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1459;
               _loc1_.blend = const_1459;
            }
            else
            {
               _window.blend = const_1458;
               _loc1_.blend = const_1458;
            }
         }
         if(isSelected)
         {
