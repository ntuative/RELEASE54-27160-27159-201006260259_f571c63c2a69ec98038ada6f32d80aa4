package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_240:LatencyTracker = null;
      
      private var var_241:PerformanceTracker = null;
      
      private var var_529:FramerateTracker = null;
      ...
      private var var_907:LagWarningLogger = null;
      
      private var var_908:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_241 = new PerformanceTracker();
         var_529 = new FramerateTracker();
         var_240 = new LatencyTracker();
         var_907 = new LagWarningLogger();
         var_1318 = new Array(const_788);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1423,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1292,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_680,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1002,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1225);
               break;
            case HabboCommunicationEvent.const_755:
               trackLoginStep(HabboLoginTrackingStep.const_1414,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_165:
               ...
               break;
            case HabboCommunicationEvent.const_241:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_241);
               if(var_240 != null)
               {
                  var_240.init();
               }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_241 != null)
            {
               var_241.connection = param1;
            }
            if(var_240 != null)
            {
               var_240.communication = _communication;
               var_240.connection = param1;
            }
            if(var_907 != null)
            {
               var_907.connection = param1;
            }
         }
      }
      ...
      {
         var_135 = IHabboConfigurationManager(param2);
         if(var_135)
         {
            Component(var_135).events.addEventListener(HabboConfigurationEvent.const_174,onConfigurationLoaded);
            if(var_240 != null)
            {
               var_240.configuration = var_135;
            }
            if(var_241 != null)
            {
               var_241.configuration = var_135;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_270.events.addEventListener(AdEvent.const_417,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1002,String(_loc2_.guestRoomId));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_908)
            {
               var_908.release(new IIDHabboWindowManager());
               var_908 = null;
            }
            if(var_270)
            {
            ...
            if(var_184)
            {
               if(true)
               {
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.const_334,onFriendlistTrackingEvent);
               }
               var_184.release(new IIDHabboFriendList());
               var_184 = null;
            }
            if(var_162)
            {
               if(true)
               {
                  var_162.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_162.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_162.release(new IIDHabboHelp());
               var_162 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_755,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_241,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_764,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_59,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_471,onHotelViewEvent);
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_135)
         {
            if(var_907 != null)
            {
               var_907.configure(var_135);
            }
            if(var_529 != null)
            {
               var_529.configure(var_135);
            }
            Component(var_135).events.removeEventListener(HabboConfigurationEvent.const_174,onConfigurationLoaded);
         }
      }
      ...
      {
         var_162 = param2 as IHabboHelp;
         var_162.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_162.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1026);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_1026,onCoreRunning);
         }
      }
      ...
      {
         var_908 = IHabboWindowManager(param2);
         if(var_908)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1092 > -1 && _loc2_ < var_1092)
         {
            ++var_1578;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1578);
         }
         if(var_1092 > -1 && _loc2_ - var_1092 > 15000)
         {
            ++var_1577;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1577);
         }
         var_1092 = _loc2_;
         if(var_241 != null)
         {
            var_241.update(param1);
         }
         if(var_240 != null)
         {
            var_240.update(param1);
         }
         if(var_529 != null)
         {
            var_529.method_9(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_135 != null && !Boolean(var_135.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         var_184 = param2 as IHabboFriendList;
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.const_334,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_135)
            {
               if(var_135.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_135.getKey("client.fatal.error.url");
                  ...
                  if(var_241 != null)
                  {
                     _loc4_["null"] = var_241.flashVersion;
                     _loc4_["null"] = var_241.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_764)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1410);
         }
