package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_517:String = "room";
      
      private static const const_785:int = -2;
      
      private static const const_518:String = "temporary_room";
      
      private static const const_297:String = "object_icon_sprite";
      
      private static const const_784:int = -3;
      
      private static const const_783:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1089:String = "tile_cursor";
      ...
      private var var_622:NumberBank;
      ...
      private var var_732:RoomMessageHandler = null;
      
      private var var_731:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_314 = new Map();
         var_622 = new NumberBank(1000);
         var_1079 = new Map();
         var_315 = new Map();
         var_69 = new RoomObjectEventHandler(this);
         var_732 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_69 != null)
         {
            ...
            {
               return var_69.deleteWallItem(var_120,var_119,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_567) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_626) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_684) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_739) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_104);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return var_69.modifyWallItemData(var_120,var_119,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_731 != null)
         {
            var_731.release(new IIDRoomRendererFactory());
            var_731 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_731.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_859;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_717);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_682);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_646);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_841);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1051);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_983) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_995);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_509,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_560,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_678,var_120,var_119,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_69 != null)
         {
            return var_69.modifyRoomObject(var_120,var_119,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_660,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_599,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_687,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_44 != null)
         {
            ...
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_252);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_63);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_69 != null)
         {
            var_69.handleRoomObjectEvent(param1,var_120,var_119);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_15.sessionDataManager = var_375;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_243,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_317,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_349,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_897,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_924,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_294,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_677,param1,param2));
      }
      
      private function method_1() : void
      {
         if(var_28 == null || var_417 == null || var_44 == null || var_731 == null || _communication == null || _habboConfiguration == null || !var_1928)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1357,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_44.getRoom(getRoomIdentifier(var_120,var_119));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_784,RoomObjectCategoryEnum.const_252);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1279);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_297);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1279);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_297);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_15 != null)
         {
            var_15.visualizationFactory = var_417;
         }
         method_1();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_207,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_411,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_430,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_156,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_688,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_113,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_98,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_136,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_485,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_422,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_476,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_424,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_410,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_405,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_472,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectMoveEvent.const_484,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_478,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_271,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_463,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_311,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_324,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_396,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_1043,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_466,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_452,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_673) != 0)
         {
            return false;
         }
         if(var_69 != null)
         {
            return var_69.initializeRoomObjectInsert(var_120,var_119,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_517 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_551,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_294,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1013,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_904,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_243));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_429);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_536)
         {
            var_1928 = true;
            method_1();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_243,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_317,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_349,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_859,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_294,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_270.events.addEventListener(AdEvent.const_417,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_783) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_590,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_731 = param2 as IRoomRendererFactory;
         method_1();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_44.getRoom(const_518);
         if(_loc10_ == null)
         {
            _loc10_ = var_44.createRoom(const_518,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_622.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_243,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_429,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
            ...
            case RoomObjectCategoryEnum.const_63:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_176,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_648,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_558,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_610,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_509,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1079.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_916,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_622.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_785,RoomObjectCategoryEnum.const_252);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_297);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1549 - _loc12_.width / 2;
               _loc11_.y = var_1548 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_447,var_120,var_119,-1,RoomObjectCategoryEnum.const_214));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_69 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_298,const_517);
                  var_69.handleRoomObjectEvent(_loc14_,var_120,var_119);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1279);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_297);
            _loc11_ = addOverlayIconSprite(_loc10_,const_297,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1549 - _loc6_.data.width / 2;
               _loc11_.y = var_1548 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_15 != null)
         {
            ...
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_350,param1.image,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_848,param1.adWarningL,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_994,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_905,RoomObjectVariableEnum.const_350,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_15 != null)
         {
            _events.addEventListener(RoomContentLoader.const_536,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_69 != null)
         {
            var_69.cancelRoomObjectInsert(var_120,var_119);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_44.getRoom(const_518);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_916);
               ...
               var_622.freeNumber(_loc10_ - 1);
               _loc13_ = var_1079.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_120,var_119,const_298,RoomObjectCategoryEnum.const_63,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_673,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_987,_loc13_,true);
            if(var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_298,const_517,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_673,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_717,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_567,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_684,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_626,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_739,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_660,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_599,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_687,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_509,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_242);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_682,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_646,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_682,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_646,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_841,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1051,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_785,const_1089,RoomObjectCategoryEnum.const_252);
         _loc7_.createRoomObject(const_784,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_252);
         return _loc7_;
      }
