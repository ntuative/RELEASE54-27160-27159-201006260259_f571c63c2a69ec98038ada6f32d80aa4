package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1666:int = 1500;
      
      private var var_1667:int = 255;
      
      private var var_1665:int = 255;
      
      private var var_1420:uint = 16777215;
      
      private var var_1167:uint = 16777215;
      
      protected var var_87:RoomPlaneParser = null;
      
      private var var_970:int = 0;
      
      private var var_1259:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_615,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_696,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_705,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_754,1);
         }
      }
      
      private function method_6(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         var _loc3_:int = param1.color;
         var _loc4_:int = param1.light;
         param2.setNumber(RoomObjectVariableEnum.const_981,int(param1.bgOnly));
         var_1420 = _color;
         var_1667 = var_1259;
         var_1167 = _loc3_;
         var_1665 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_904:
               param2.setNumber(RoomObjectVariableEnum.const_696,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1013:
               param2.setNumber(RoomObjectVariableEnum.const_705,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_754,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_509:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_242)
               {
                  _loc5_ = "null";
               }
               var_446.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_560:
               _loc4_ = var_446.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_446.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_910,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_660:
               param2.setString(RoomObjectVariableEnum.const_648,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_599:
               param2.setString(RoomObjectVariableEnum.const_558,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_687:
               param2.setString(RoomObjectVariableEnum.const_610,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_970)
         {
            ...
            {
               _loc7_ = var_1420 >> 16 & 255;
               _loc8_ = var_1420 >> 8 & 255;
               _loc9_ = var_1420 & 255;
               _loc10_ = var_1167 >> 16 & 255;
               _loc11_ = var_1167 >> 8 & 255;
               _loc12_ = var_1167 & 255;
               _loc13_ = (_loc2_ - var_970) / var_1666;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1667 + (var_1665 - var_1667) * _loc13_;
               _color = _loc3_;
               var_1259 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_615,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1219,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1243,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_142 || _loc13_ == RoomPlaneData.const_248)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
