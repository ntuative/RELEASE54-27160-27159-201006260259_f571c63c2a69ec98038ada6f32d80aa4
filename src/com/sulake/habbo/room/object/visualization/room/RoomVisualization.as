package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1319:int = 13421772;
      
      private static const const_808:int = 16777215;
      
      public static const const_1428:int = 10066329;
      
      private static const const_811:int = 13421772;
      
      public static const const_1387:int = 16777215;
      
      public static const const_1353:int = 16777215;
      
      private static const const_809:int = 10066329;
      
      private static const const_810:int = 10066329;
      
      public static const const_1245:int = 13421772;
      ...
      private var var_1825:int = -1000;
      
      private var var_1127:uint = 16777215;
      ...
      private var var_654:Rectangle = null;
      ...
      private var var_2103:Number = 0.0;
      ...
      private var var_446:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_446 = new RoomPlaneBitmapMaskParser();
         var_328["null"] = false;
         var_328["null"] = true;
         var_328["null"] = true;
         var_328["null"] = true;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_87.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_82,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1353;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1245;
               }
               else
               {
                  _loc13_.color = const_1428;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1196)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_105,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_910);
            if(_loc3_ != var_2108)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_615));
            if(_loc4_ != var_1127)
            {
               var_1127 = _loc4_;
               var_2104 = var_1127 & 255;
               var_2107 = var_1127 >> 8 & 255;
               var_2105 = var_1127 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_981));
            if(_loc5_ != var_1617)
            {
               var_1617 = _loc5_;
               _loc2_ = true;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_654 == null)
         {
            var_654 = super.boundingRectangle;
         }
         return new Rectangle(var_654.x,var_654.y,var_654.width,var_654.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         while(_loc7_ < var_109.length)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc3_.type == RoomPlane.const_82)
               {
                  _loc4_.push(_loc7_);
               }
            }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_446.maskCount)
         {
            _loc10_ = var_446.getMaskType(_loc8_);
            _loc11_ = var_446.getMaskLocation(_loc8_);
            _loc12_ = var_446.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_82)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_82 && _loc12_ == RoomPlaneBitmapMaskData.const_242)
                              {
                                 _loc3_.addBitmapMask(_loc10_,_loc16_,_loc17_);
                              }
                              else if(_loc3_.type == RoomPlane.const_82)
                              {
      ...
      {
         if(param1 != var_328["null"] || param2 != var_328["null"] || param3 != var_328["null"])
         {
            var_328["null"] = param1;
            var_328["null"] = param2;
            var_328["null"] = param3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_1825 + const_1743 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_212.length)
         {
            _loc9_ = 0;
            _loc10_ = getSprite(_loc9_);
            _loc11_ = var_212[_loc8_] as RoomPlane;
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_82)
            {
               if(var_1617)
               {
                  _loc12_ = uint(_loc11_.color);
                  _loc13_ = uint((_loc12_ & 255) * var_2104 / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * var_2107 / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_2105 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_82 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:Boolean = false;
         if(param1.updateId != var_1446)
         {
            var_1446 = param1.updateId;
            var_654 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != var_1175 || _loc3_.y != var_2103 || _loc3_.z != var_2109 || param1.scale != var_2106))
            {
               var_1175 = _loc3_.x;
               var_2103 = _loc3_.y;
               var_2109 = _loc3_.z;
               var_2106 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_170 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_558);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_648);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_610);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_696));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_705));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_754));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1516;
      }
