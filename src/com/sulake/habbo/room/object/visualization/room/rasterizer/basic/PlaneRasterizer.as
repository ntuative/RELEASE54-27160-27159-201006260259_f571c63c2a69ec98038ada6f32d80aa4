package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_511:String = "HabboMessengerCom_msg_entry_xml";
      ...
      private var var_853:IGraphicAssetCollection = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_853.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_175.getValue(_loc6_) == null)
               {
      ...
      {
         return var_322.getValue(param1) as PlaneMaterial;
      }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_322.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_175.getValue(param1) as PlaneTexture;
      }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = var_175.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_322.length)
         {
            _loc3_ = var_322.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
