package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_82:int = 3;
      ...
      private var var_703:IPlaneRasterizer = null;
      ...
      private var var_600:PlaneMaskManager = null;
      ...
      private var var_701:Boolean = true;
      ...
      private var var_1506:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_1757 = param8;
         var_845 = new Vector3d();
         var_845.assign(param1);
         var_76 = new Vector3d();
         ...
         var_487 = Vector3d.crossProduct(var_291,var_290);
         if(false)
         {
            var_487.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_105 || _type == const_82))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_844 || false && false && !var_158 || var_600 == null)
         {
            return;
         }
         ...
         if(var_158)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_487);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_198.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_600.updateMask(var_59,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_702.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_265.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1040.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_158 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_703 != null)
         {
            return var_703.getTextureIdentifier(param1,normal);
         }
      ...
      {
         if(var_126 == null || var_106 == null || var_79 == null || var_107 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_105 || _type == const_82)
         {
         ...
         if(true)
         {
            while(_loc1_ < var_198.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_702[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1221.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1221[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_845);
            _loc7_ = _loc6_.z;
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         var_106.assign(param1.getScreenPosition(Vector3d.sum(var_76,var_290)));
         var_79.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_76,var_291),var_290)));
         var_107.assign(param1.getScreenPosition(Vector3d.sum(var_76,var_291)));
         _offset = param1.getScreenPoint(var_845);
         ...
         var _loc2_:Number = Math.min(var_126.x,var_106.x,var_79.x,var_107.x);
         var _loc3_:Number = Math.max(var_126.x,var_106.x,var_79.x,var_107.x);
         var _loc4_:Number = Math.min(var_126.y,var_106.y,var_79.y,var_107.y);
         var _loc5_:Number = Math.max(var_126.y,var_106.y,var_79.y,var_107.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_126.x = 0 - _loc2_;
         var_106.x = 0 - _loc2_;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(var_701 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_158))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_487);
            _loc4_ = getTextureIdentifier(param1.scale);
            if(var_228 != null)
            {
               _loc3_ = var_228;
            ...
            if(var_703 != null)
            {
               _loc3_ = var_703.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1506,var_1756,var_1753,var_1755,var_1758,param2);
               if(_loc3_ != null)
               {
