package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_528:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_528 = var_278.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_528 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_278 != null)
         {
            ...
            {
               _loc1_ = var_278.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_278.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_278.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
