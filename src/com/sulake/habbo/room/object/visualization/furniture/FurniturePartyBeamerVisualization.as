package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_815:int = 15;
      
      private static const const_1153:int = 2;
      
      private static const const_366:int = 2;
      
      private static const const_816:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1164[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1166[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1164 = new Array();
         var_1164.push(Math.random() * _loc2_ * 1.5);
         var_1164.push(Math.random() * _loc2_ * 1.5);
         var_1165 = new Array();
         var_1165.push(1);
         var_1165.push(-1);
         var_1163 = new Array();
         var_1163.push(const_1153);
         var_1163.push(const_1152);
         var_1166 = new Array();
         var_1166.push(getRandomAmplitudeFactor());
         var_1166.push(getRandomAmplitudeFactor());
      }
