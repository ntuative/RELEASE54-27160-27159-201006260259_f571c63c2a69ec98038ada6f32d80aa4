package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_221[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1575)
         {
            ...
            param1 %= var_389;
            if(var_1465 > 0 && _loc4_ >= var_1465 || var_1465 <= 0 && var_389 == 1)
            {
               param1 = var_389 - 1;
               _loc3_ = true;
            }
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_221.length)
            {
               _loc2_ = var_221[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_221[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_221.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_221[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
