            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_124,const_67,const_58,const_124,const_67,const_58];
                     _loc8_ = [const_67,const_67,const_67,const_58,const_58,const_58];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
