package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_479:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_499,onTaskDoneEvent);
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_35 != null && (var_35.id == const_234 || var_35.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1716;
         _window.width = _loc2_.width + var_1715;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_499,onTaskDoneEvent);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_499:
               var_1091 = true;
               if(var_35 != null && var_35.id == const_479)
               {
                  showView(const_87);
               }
               break;
            case HabboHelpTutorialEvent.const_394:
               if(var_35 != null && var_35.id == const_341)
               {
                  var_1317 = true;
                  disposeWindow();
               }
      ...
      {
         var_1089 = true;
         if(var_35 != null && (var_35.id == const_341 || var_35.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      {
         return var_1089 && var_1090 && var_1091;
      }
   }
}
