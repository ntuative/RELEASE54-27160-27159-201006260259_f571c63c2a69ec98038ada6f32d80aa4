package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1676:uint = 13232628;
      
      private static var var_2253:uint = 11129827;
      ...
      private var var_978:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _controller.localization.registerParameter("help.tutorial.name.available","name",var_390);
      ...
      private function showSelectionView() : void
      {
         if(!var_682)
         {
            var_682 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_682)
            {
               return;
            }
            _window.content.addChild(var_682);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_288)
         {
            var_288 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_288)
            {
               return;
            }
            _window.content.addChild(var_288);
         }
         _window.caption = _controller.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_288.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_390;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!var_1005)
         {
            if(param1.type == WindowEvent.const_133)
            {
         ...
         switch(param2.name)
         {
            ...
            case "confirm_name_button":
               _controller.changeName(var_390);
               break;
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1475 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_978 = new NameSuggestionListRenderer(_controller);
         var _loc6_:int = var_978.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1676;
