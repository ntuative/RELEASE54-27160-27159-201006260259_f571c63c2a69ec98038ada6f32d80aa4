package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1485:int = 0;
      
      private static const const_1484:int = 0;
      ...
      private var var_2388:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","27160-27159-201006260246");
         _toolbar = param5;
         var_114 = new Map();
         var_114.add(HabboHelpViewEnum.const_1241,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_147,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_494,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_254,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_198,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_627,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_310,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_537,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_210,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_114.add(HabboHelpViewEnum.const_938,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_114.add(HabboHelpViewEnum.const_666,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1715 = 0 - _loc3_.width;
         var_1716 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_300 == HabboHelpViewEnum.const_147 || false)
         {
            return;
         }
         if(var_473 == null)
         {
            ...
            var_473 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_473 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_473 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_473 as IWindow);
      ...
      {
         return var_114.getValue(var_300);
      }
      ...
      {
         var_2390 = param1;
         var _loc2_:IHelpViewController = var_114.getValue(HabboHelpViewEnum.const_147) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_210:
               showUI(HabboHelpViewEnum.const_210);
               break;
            case CallForHelpResultEnum.const_890:
               showUI(HabboHelpViewEnum.const_938);
               break;
            case CallForHelpResultEnum.const_996:
      ...
      {
         var _loc3_:* = null;
         if(var_300 == HabboHelpViewEnum.const_147)
         {
            return;
         }
         if(true)
         {
            ...
            var_685.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_685.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_473.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_685[1],var_685[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_685[0],var_685[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1716;
         _window.width = _loc1_.width + var_1715;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_300);
            return;
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_25.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_499));
      }
