package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new CallForHelpPendingCallsDeletedMessageEvent(method_7));
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_25.tellUI(HabboHelpViewEnum.const_198,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_254,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_147);
      }
      ...
      {
         var_25.showUI(HabboHelpViewEnum.const_310);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_494);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_25.showUI(HabboHelpViewEnum.const_627);
         var_25.tellUI(HabboHelpViewEnum.const_627,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_353)
            {
         ...
         var_25.tellUI(HabboHelpViewEnum.const_666);
      }
