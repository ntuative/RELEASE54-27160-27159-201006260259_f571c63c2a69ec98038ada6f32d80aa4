package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         var_56.caption = "Room visits: " + param1.userName;
         populate();
         onResizeTimer(null);
         var_56.visible = true;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1967.clone());
         ...
         new OpenRoomTool(var_56,_main,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1967 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_56 = IFrameWindow(_main.getXmlWindow("roomvisits_frame"));
         var_51 = IItemListWindow(var_56.findChildByName("visits_list"));
