package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_782:ICheckBoxWindow;
      
      private var var_56:IFrameWindow;
      
      private var var_1145:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_585,_data.flatId),var_56,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_782.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1390,_loc2_,var_431.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1144.isSelected,var_1145.isSelected,var_782.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1314);
      }
      
      public function populate() : void
      {
         var_51 = IItemListWindow(var_56.findChildByName("list_cont"));
         ...
         var_782 = ICheckBoxWindow(var_56.findChildByName("kick_check"));
         var_1144 = ICheckBoxWindow(var_56.findChildByName("lock_check"));
         var_1145 = ICheckBoxWindow(var_56.findChildByName("changename_check"));
