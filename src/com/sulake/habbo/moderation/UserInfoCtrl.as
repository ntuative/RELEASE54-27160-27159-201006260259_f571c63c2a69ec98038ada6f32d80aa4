package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_768:int = 31536000;
      
      private static const const_769:int = 86400;
      
      private static const const_771:int = 3600;
      
      private static const const_770:int = 60;
      ...
      {
         if(param1 < 2 * const_770)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_771)
         {
            return Math.round(param1 / const_770) + " mins ago";
         }
         if(param1 < 2 * const_769)
         {
            return Math.round(param1 / const_771) + " hours ago";
         }
         if(param1 < 2 * const_768)
         {
            return Math.round(param1 / const_769) + " days ago";
         }
         return Math.round(param1 / const_768) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_839,_data.userId),_callerFrame,var_1039,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_843.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_843.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1330),_callerFrame,var_1039,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1039,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1330),_callerFrame,var_1039,false,true);
      }
