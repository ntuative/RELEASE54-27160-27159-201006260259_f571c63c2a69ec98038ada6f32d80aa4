package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new UserInfoFrameCtrl(_main,_userId),var_56,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1462 ? 0 : 1,_roomId),_main,WindowTracker.const_585,_roomId),var_56,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomToolCtrl(_main,_roomId),var_56,false,false,true);
      }
      ...
      public function show() : void
      {
         if(var_56 == null)
         {
            var_56 = IFrameWindow(_main.getXmlWindow("start_panel"));
            ...
            var_56.findChildByName("room_tool_but").disable();
            var_56.findChildByName("chatlog_but").disable();
            _main.disableButton(_main.initMsg.cfhPermission,var_56,"ticket_queue_but");
