package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_939:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_129:HabboMessenger;
      
      private var var_1364:ConversationView;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_810.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1364.afterResize();
         this.var_939.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_810.text = "";
         var_129.conversations.addMessageAndUpdateView(new Message(Message.const_625,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      {
         return this.var_939 == null ? 7 : int(this.var_939.getTabCount());
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_939 = new ConversationsTabView(var_129,var_18);
         var_939.refresh();
         var_810 = ITextFieldWindow(var_18.findChildByName("message_input"));
         var_810.addEventListener(WindowKeyboardEvent.const_144,onMessageInput);
         var_1364 = new ConversationView(var_129,var_18);
         var_18.scaler.setParamFlag(HabboWindowParam.const_683,false);
         var_18.scaler.setParamFlag(HabboWindowParam.const_851,true);
      }
   }
}
