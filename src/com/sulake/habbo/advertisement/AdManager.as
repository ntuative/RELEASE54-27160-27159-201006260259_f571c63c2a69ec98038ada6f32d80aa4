package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_982:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_417,0,0,_loc4_,var_1678,var_982,var_983));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2281 = _config.getKey("interstitial.enabled","false") == "true";
         var_2278 = int(_config.getKey("interstitial.interval","30000"));
         var_2279 = int(_config.getKey("interstitial.show.time","5000"));
         var_1680 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1439 = _loc2_.imageUrl;
         var_1678 = _loc2_.clickUrl;
         if(var_1439 != "" && var_1678 != "")
         {
            _loc3_ = var_1439;
            ...
            _loc4_ = new URLRequest(var_1439);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1440 = _loc2_.imageUrl;
         var_2280 = _loc2_.clickUrl;
         var_805 = getTimer();
         if(var_1440 != "")
         {
            _loc3_ = var_1440;
            ...
            if(var_254 == null)
            {
               var_254 = new Timer(var_2279,1);
               var_254.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_254.reset();
            ...
            var_254.start();
            _loc4_ = new URLRequest(var_1440);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_390,0,0,param1.bitmapData,var_2280));
            var_805 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_983 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1680 > 0 && var_1679 >= var_1680)
         {
            return false;
         }
      ...
      {
         var_331 = param2 as IHabboCommunicationManager;
         if(var_331 == null)
         {
            return;
         }
         _connection = var_331.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_982 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
