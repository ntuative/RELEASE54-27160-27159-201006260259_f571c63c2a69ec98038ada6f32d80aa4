package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1121:String = "badges";
      
      private static const const_1123:String = "pet_inventory";
      
      private static const const_1124:String = "pixelbalance";
      
      private static const const_1125:String = "credits";
      
      private static const const_1126:String = "inventory";
      
      private static const const_1120:String = "friendlist";
      
      private static const const_1119:String = "selectfurni";
      
      private static const const_1122:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_648:ParkBusDialogManager;
      
      private var var_647:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_438:HabboNotificationViewManager;
      
      private var var_762:ClubEndingNotification;
      ...
      private var var_211:HabboAlertDialogManager;
      
      private var var_763:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_931);
         }
         var _loc6_:Map = var_931["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1326);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_763 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_211 == null)
         {
            return;
         }
         var_211.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_211.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_211.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_647)
         {
            var_647.release(new IIDHabboToolbar());
            var_647 = null;
         }
         if(_windowManager)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1274);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2063)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_992);
            var_2063 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1121:
               if(var_14 != null)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_269);
               }
               break;
            case const_1122:
               break;
            case const_1126:
               if(var_14 != null)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_75);
               }
               break;
            case const_1123:
               if(var_14)
               {
                  var_14.toggleInventoryPage(InventoryCategory.const_150);
               }
               break;
            case const_1119:
               break;
      ...
      {
         if(param1 != null && this.var_438 != null)
         {
            var_438.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_992,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_454.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_30,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_40);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_963,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_162 || param2.type == WindowEvent.const_609)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_438.isSpaceAvailable() && false)
         {
            var_438.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_648 == null)
         {
            var_648 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_648 != null)
         {
            var_648.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1115.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_454.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_375);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc9_ = var_375.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc9_ = var_375.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_375.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1214,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_454.createAvatarImage(param2,AvatarScaleType.const_46);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_40,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_40);
            _loc7_.dispose();
         }
         if(param3 == "")
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1115.push(_loc8_);
         return var_1115.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1406)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_762 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_211 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_647 = IHabboToolbar(param2);
         var_647.events.addEventListener(HabboToolbarEvent.const_88,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_211.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_375.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_929);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_929);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_211.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_88)
         {
            ...
            var_438 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_931["styles"],var_931["view"],var_647);
            ...
            registerUpdateReceiver(var_438,1);
            registerUpdateReceiver(this,2);
            var_375.events.addEventListener(BadgeImageReadyEvent.const_131,onBadgeImage);
            var_647.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
