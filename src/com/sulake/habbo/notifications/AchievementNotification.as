package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1879 = param2;
         var_375 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_131,onBadgeImageReady);
         ...
         var_2319 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_375 != null)
         {
            var_375.events.removeEventListener(BadgeImageReadyEvent.const_131,onBadgeImageReady);
            var_375 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_818,var_2319);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_818,var_818));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_818,var_818));
         _localizations.registerParameter(param1,"level",var_1879.toString());
         _localizations.registerParameter(param1,"name",var_375.userName);
         _localizations.registerParameter(param1,"realname",var_375.realName);
      }
   }
}
