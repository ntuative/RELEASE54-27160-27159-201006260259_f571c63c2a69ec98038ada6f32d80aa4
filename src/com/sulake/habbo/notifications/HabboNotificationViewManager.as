package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_516:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_516;
         var _loc2_:int = 0;
         while(_loc2_ < var_232.length)
         {
            _loc3_ = var_232[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_726 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_726 + const_516;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_1870,var_460,_toolbar);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_726 < 540;
      }
   }
}
