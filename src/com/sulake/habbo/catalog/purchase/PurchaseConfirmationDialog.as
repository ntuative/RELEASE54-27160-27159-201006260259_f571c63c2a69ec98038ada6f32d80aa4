package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1479:uint = 4.293848814E9;
      
      private var var_891:int;
      
      private const const_1727:uint = 4.291613146E9;
      
      private var var_275:int = -1;
      ...
      private const const_1726:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_237.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_890;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_890,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1479) : uint(const_1478);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_423,var_81,var_1084);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_237.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_275) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_890);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_624[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_623[var_204]);
         _catalog.purchaseProductAsGift(var_423,var_81,var_1084,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_133:
               ...
               for each(_loc7_ in var_245)
               {
                  ...
                  if(_loc5_.length >= const_1726)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1941 = _loc3_.text;
               break;
            case WindowMouseEvent.const_49:
               showSuggestions(false);
               if(var_1292)
               ...
               break;
            case WindowKeyboardEvent.const_546:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_275 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_275 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1556 = _loc1_.stuffTypes;
            var_624 = _loc1_.boxTypes;
            var_623 = _loc1_.ribbonTypes;
            var_890 = var_1556[0];
            _boxIndex = var_624[0];
            var_204 = var_623[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_237.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_275) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_275);
         }
         var_275 = param1;
         if(var_275 < 0)
         {
            var_275 = _loc2_.numListItems - 1;
         }
         if(var_275 >= _loc2_.numListItems)
         {
            var_275 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_275) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_237 == null)
         {
            var_237 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_520 == null)
         {
            var_520 = createWindow("suggestion_list_item") as IWindowContainer;
            var_520.procedure = suggestionsEventHandler;
         }
         if(var_237 == null || var_520 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_237.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_520.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
