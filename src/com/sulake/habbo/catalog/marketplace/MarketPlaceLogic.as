package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1753:int = 3;
      
      public const const_1581:int = 2;
      ...
      private var var_2266:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1569,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2265 || param1.furniTypeId != var_2263)
         {
            return;
         }
         var_2266 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1581,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_384)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1934 = _loc3_.creditsWaiting;
         var_220 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_209)
         {
            var_209 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_209.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2262,var_2264,var_2227,var_2261);
      }
