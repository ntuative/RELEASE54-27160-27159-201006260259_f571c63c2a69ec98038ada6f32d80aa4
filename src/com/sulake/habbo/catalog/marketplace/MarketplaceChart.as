package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1051 + var_1051 / -var_2502 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_854 - var_854 / var_411 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_411).toString().length - 1);
         var_411 = Math.ceil(var_411 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_411.toString();
         _loc3_.draw(_loc6_);
         var_1051 = param1 - _loc6_.textWidth - 2;
         var_854 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_854);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_854 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1051,(param2 - var_854) / 2));
         return _loc3_;
      }
