package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2508:String = "catalog.page.club";
      
      private var var_2533:String = "magic.credits";
      ...
      {
         _catalog.openCatalogPage(var_2508,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_282.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = var_282.indexOf(_loc6_);
            var_282.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
