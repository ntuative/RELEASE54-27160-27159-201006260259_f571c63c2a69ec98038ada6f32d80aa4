package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1115:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1599:XML;
      
      private static var var_1600:XML;
       
      
      private var var_2466:IWindowContainer;
      ...
      private var var_1601:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1599 == null)
         {
            ...
            var_1599 = _loc4_.content as XML;
         }
         if(var_1600 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1601 == 4294967295)
            {
               var_1601 = _loc1_.color;
            }
            _loc1_.color = const_1115;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1599) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_51 = navigator.catalog.windowManager.buildFromXML(var_1600) as IItemListWindow;
         if(var_51 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1195;
            }
         }
      }
