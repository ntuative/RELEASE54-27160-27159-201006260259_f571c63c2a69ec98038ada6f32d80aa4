package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1180:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1181 != null)
         {
            var_1181.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1180 != null)
         {
            var_1180.removeEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1181 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1181 != null)
         {
            var_1181.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1180 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1180 != null)
         {
            var_1180.addEventListener(WindowKeyboardEvent.const_144,windowKeyEventProcessor);
         }
      }
