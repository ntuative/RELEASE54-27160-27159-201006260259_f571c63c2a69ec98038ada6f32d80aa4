package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_401 >= var_308.length)
         {
            return "";
         }
         var petColor:IPetColor = var_308[var_401] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_596[var_1507] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_401 < 0 || var_401 > var_308.length)
         {
            var_401 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_597.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_133,onTextWindowEvent);
         var_597 = new Map();
         ...
         var_847 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_308 = [];
         var_596 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_847,this);
               if(_loc11_)
               {
                  var_596 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_596.length)
         {
            _loc12_ = var_596[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_847,_loc12_.id),getRaceLocalizationKey(var_847,_loc12_.id)));
            _loc6_++;
         }
         var_597.add(var_847,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_883,onApproveNameResult);
         _loc5_ = var_597.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_597.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_401 >= 0 && var_401 < var_308.length)
         {
            _loc7_ = var_308[var_401] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_596[var_1507] as IBreed;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_847,_loc3_.id,_loc2_,AvatarScaleType.const_46,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_266,AvatarAction.const_703);
