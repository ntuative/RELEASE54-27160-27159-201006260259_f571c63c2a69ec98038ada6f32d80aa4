package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_310:IGridItem;
      
      protected var var_1028:IItemGridWindow;
      
      protected var var_1372:XML;
      
      private var var_1290:Map;
      
      private var var_736:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_1028 = _window.findChildByName("botGrid") as IItemGridWindow;
         var_1555 = new Map();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = var_1555.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = var_1290.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var_1028.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1290.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            var_1555.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = var_1290.getValue(var_736.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_736,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_736.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_736.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_736.localizationId);
