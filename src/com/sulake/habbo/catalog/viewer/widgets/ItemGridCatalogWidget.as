   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_570,activateScrollbar);
            ...
            _scrollBar.addEventListener(WindowEvent.const_217,deActivateScrollbar);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_923 >= 0 && var_923 < page.offers.length)
            {
               _loc4_ = page.offers[var_923];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_418)
         {
            ++var_1598;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1598);
         }
      }
      
      override public function init() : void
      {
         var_1028 = _window.findChildByName("itemGrid") as IItemGridWindow;
