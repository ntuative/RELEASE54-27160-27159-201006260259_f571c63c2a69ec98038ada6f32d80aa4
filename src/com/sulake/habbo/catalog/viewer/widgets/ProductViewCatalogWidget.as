package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1385:IScrollbarWindow;
      
      protected var var_1372:XML;
      
      private var var_1384:BitmapData;
      
      private var var_1333:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_662 != null)
         {
            var_662.visible = false;
            var_662.destroyGridItems();
         }
         if(var_1385 != null)
         {
            var_1385.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1332.text = "${" + _loc3_.name + "}";
            var_1333.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1332.text = "${" + _loc2_.localizationId + "}";
            var_1333.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_418:
                  _loc4_ = var_1384.clone();
                  if(var_662 != null)
                  {
                     var_662.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_662,var_1385,var_1372);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_205:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_46);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_40,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_266,AvatarAction.const_420);
                              _loc13_.appendAction(AvatarAction.const_377,_loc6_.productClassId);
      ...
      {
         var_1332 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1333 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1642 = new Point(var_89.x,var_89.y);
         var_662 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1385 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_662 == null)
         {
         ...
         var_1384 = _loc2_.content as BitmapData;
