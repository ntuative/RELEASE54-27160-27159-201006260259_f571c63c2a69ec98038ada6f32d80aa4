package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_933:MarketPlaceOfferData;
      
      private const const_1452:int = 1;
      
      private const const_1741:int = 40;
      
      private var var_544:IWindowContainer;
      
      private const const_1451:int = 2;
      ...
      private function updateList() : void
      {
         ...
         if(!var_544)
         {
            ...
            var_544 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_544)
         {
            return;
         ...
         updateStatusDisplay(const_1451,_loc2_.length);
         if(!var_440)
         {
            var_440 = new Timer(25);
            var_440.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_934 = 0;
         populateList();
         var_440.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_597)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_544 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_544.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1452);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_439.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_440)
         {
            var_440.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_440 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_934 >= var_597.length)
            {
               return true;
            }
            addListItem(var_597.getWithIndex(var_934));
            ++var_934;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_933.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_133)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_439));
            _loc7_.selection = 0;
         }
      }
