package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1169:ITextFieldWindow;
      ...
      {
         super.init();
         var_1169 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1169 != null)
         {
            var_1169.addEventListener(WindowKeyboardEvent.const_546,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1169.text));
      }
   }
}
