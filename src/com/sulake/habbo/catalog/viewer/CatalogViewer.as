package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1544:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_423 != null)
         {
            if(var_423.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_423.window);
            var_423.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1544);
         var_423 = _loc5_;
      ...
      {
         return var_423.dispatchWidgetEvent(param1);
      }
