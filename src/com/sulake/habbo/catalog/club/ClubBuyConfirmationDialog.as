package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_81:ClubBuyOfferData;
      ...
      {
         if(!param1 || !param2 || !_controller || !var_81)
         {
            return;
         }
         ...
         {
            case "select_button":
               _controller.confirmSelection(var_81,var_423);
               break;
      ...
      {
         var _loc1_:* = null;
         if(var_81 && false && var_81.productContainer.firstProduct)
         {
            _loc1_ = var_81.productContainer.firstProduct.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc13_:int = var_81.periods == 0 ? 1 : int(var_81.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(var_81.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(var_81.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(var_81.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(var_81.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(var_81.daysLeftAfterPurchase));
         if(false)
         {
