package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_823:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1700)
         {
            case RecyclerStatusMessageEvent.const_1282:
               var_297 = const_368;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_914:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1382:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1700 != RecyclerStatusMessageEvent.const_914;
      }
      
      private function get statusActive() : Boolean
      {
         return var_297 != const_823;
      }
      ...
      {
         return active && var_297 == const_368;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_887:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1376:
