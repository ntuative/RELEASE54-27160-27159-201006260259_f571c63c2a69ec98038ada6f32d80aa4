package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1463:int = 60000;
      ...
      private var var_846:IAvatarImage;
      ...
      {
         if(var_625 == param1 || var_625 == GeometryType.const_908 && param1 == GeometryType.const_872 || param1 == GeometryType.const_908 && var_625 == GeometryType.const_872)
         {
            var_625 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_711)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_501)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_82.getParts(param1,var_846.getFigure(),_loc6_,var_625,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_154,var_625);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1221[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_1044 || _loc30_ == AvatarAction.const_482) && (_loc6_ == AvatarBodyPartType.const_194 || _loc6_ == AvatarBodyPartType.const_1265 || _loc6_ == AvatarBodyPartType.const_1220) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_154 == AvatarScaleType.const_46)
                  {
                     _loc31_.x += 65;
                  }
                  else
