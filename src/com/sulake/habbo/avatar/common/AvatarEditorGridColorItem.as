package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_722:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_723.width,var_723.height,true,0);
            _loc1_.bitmap.copyPixels(var_723,var_723.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_867.width,var_867.height,true,0);
            _loc5_ = var_867.clone();
            _loc5_.colorTransform(_loc5_.rect,var_722.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_721.width,var_721.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_721,var_721.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(var_722)
            {
               switch(var_722.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_48:
                     _loc4_.style = HabboIconType.const_598;
                     _loc4_.visible = true;
               }
            }
            else
