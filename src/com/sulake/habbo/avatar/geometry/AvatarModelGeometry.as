package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1616:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         var_550 = new Matrix4x4();
         var_766 = new Dictionary();
         var_1616 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_766[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_550 = var_550.identity().rotateY(param3);
            return _loc5_.getParts(var_550,var_940,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1616.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_766[param1] as Dictionary;
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_550 = var_550.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_550);
            _loc10_ = _loc8_.getDistance(var_940);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_766[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1616.findAvatarSet(param1);
         if(_loc3_ != null)
         {
