package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1520:Number = 1.0;
      ...
      private var var_1517:Number = 1.0;
      
      private var var_2299:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1517,var_1520,var_1521,_alphaMultiplier);
         var_1177 = generatePaletteMapForGrayscale(var_2297,var_2298);
      }
      
      public function get reds() : Array
      {
         return var_1177.getValue("reds") as Array;
      }
      ...
      {
         return var_1177.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1177.getValue("greens") as Array;
      }
      ...
      {
         return var_1177.getValue("alphas") as Array;
      }
