package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_427:PartSetsData;
      
      private var var_1573:PartOffsetData;
      
      private var var_904:AvatarActionManager;
      
      private var var_183:IAssetLibrary;
      
      private var var_903:IAssetLibrary;
      ...
      private var var_1574:AvatarStructureDownloadSet;
      
      private var var_744:Dictionary;
      
      private var var_743:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_183 = param2;
         var_903 = param3;
         var_317 = new FigureData();
         var_427 = new PartSetsData();
         var_652 = new AnimationData();
         var_1574 = new AvatarStructureDownloadSet();
         var_743 = new AnimationManager();
         var_629 = param4;
         var_1573 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_904.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_629)
         {
            case AvatarType.const_65:
               _loc1_ = var_183.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_427.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_183.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_652.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_183.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_317.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_183.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_427.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_183.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_652.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_183.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_317.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_904.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_317.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_904.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_743.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_427.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_427.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1377[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_904.getDefaultAction();
         var _loc9_:Array = var_427.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_743.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_317.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_317.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_427.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_427.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_629 + " ready to go!");
         if(var_629 == AvatarType.const_65)
         {
            var_427.getPartDefinition("ri").appendToFigure = true;
            var_427.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_65:
               if(var_183.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_183.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_183.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_183.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_65:
               if(var_183.hasAsset(_loc5_))
               {
                  var_183.removeAsset(var_183.getAssetByName(_loc5_));
               }
               var_1574.add(new AvatarStructureDownload(var_183,_loc5_,var_317));
               break;
            case AvatarType.PET:
         }
         var_1574.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_743.getAnimation(param1);
      }
      ...
      {
         var_904 = new AvatarActionManager(var_183,var_629);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_744[param1] = new Dictionary();
         }
         if(var_744[param1][param2])
         {
            return var_744[param1][param2];
         }
         var_744[param1][param2] = var_317.getMandatorySetTypeIds(param1,param2);
         return var_744[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_317.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_903.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_903.getAssetByName("dance" + _loc1_).content as XML;
            var_743.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_903.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_903.getAssetByName("fx" + _loc1_).content as XML;
            var_743.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_317.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_317.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1573.loadOffsets(var_903);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_904.sortActions(param1);
      }
   }
}
