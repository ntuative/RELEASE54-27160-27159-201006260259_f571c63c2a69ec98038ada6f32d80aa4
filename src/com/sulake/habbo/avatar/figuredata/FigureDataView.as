package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1080:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1080 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_360 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_360 && var_1080)
         {
            var_360.bitmap = new BitmapData(var_360.width,var_360.height,true,16777215);
            var_360.bitmap.copyPixels(var_1080,var_1080.rect,new Point(0,0 - 0 - 8));
            var_360.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
