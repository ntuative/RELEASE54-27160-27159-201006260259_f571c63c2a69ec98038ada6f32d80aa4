package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2527:Dictionary;
      ...
      private var var_902:RoomCreateViewCtrl;
      ...
      private var var_527:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_435:Tabs;
      
      private var var_277:MainViewCtrl;
      
      private var var_1969:Array;
      
      private var var_1143:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_527 = new RoomInfoViewCtrl(this);
         var_902 = new RoomCreateViewCtrl(this);
         var_1823 = new RoomThumbnailRenderer(this);
         var_1143 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_435 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_277.startSearch(Tabs.const_224,Tabs.const_320,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_135.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_527.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_277.startSearch(Tabs.const_292,Tabs.const_219);
         var_435.getTab(Tabs.const_292).tabPageDecorator.tabSelected();
      }
