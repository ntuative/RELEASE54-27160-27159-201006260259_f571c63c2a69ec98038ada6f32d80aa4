package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1661:IButtonWindow;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1662,this._model.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1661,this._model.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1662 = IButtonWindow(find("top_tab"));
         var_1661 = IButtonWindow(find("obj_tab"));
         var_2229 = IWindowContainer(find("tile_grid"));
         var_2228 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1662,onTopTabButton);
         Util.setProcDirectly(var_1661,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2229;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_449)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2228;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_52,HabboWindowStyle.const_36,HabboWindowParam.const_69,new Rectangle(0,0,param1.width,66)));
