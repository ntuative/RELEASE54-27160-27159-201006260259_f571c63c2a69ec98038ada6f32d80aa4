package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_976:IWindow;
      
      private var var_408:Number;
      
      private var var_975:ITextWindow;
      
      private var var_191:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_977 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_191.duration);
               var_977.width = _loc2_ * var_408;
            }
            else
            {
               var_977.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_976 = _window.findChildByName("effect_hilite");
            var_976.visible = false;
         }
         var_975 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_977 = _window.findChildByName("loader_bar");
         if(var_977 != null)
         {
            var_408 = var_977.width;
            var_186.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_191.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_975 != null)
         {
            var_975.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_975.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
