package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1353:XML;
      
      private var var_401:int;
      
      private var var_543:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2061:int;
      
      private var var_374:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_52,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1066,const_1064,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_543 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_374 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_543 != null)
         {
            var_543.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_374 != null)
         {
            var_374.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1114 = _loc2_.light;
         if(var_374 != null)
         {
            var_374.setValue(var_1114);
         }
         var_401 = colors.indexOf(_loc2_.color);
         if(var_543 != null)
         {
            var_543.setSelectedColorIndex(var_401);
         }
