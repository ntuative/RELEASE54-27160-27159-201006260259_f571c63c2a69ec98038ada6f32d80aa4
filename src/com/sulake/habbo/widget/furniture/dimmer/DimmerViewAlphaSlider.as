package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_97 && param1.type != WindowMouseEvent.const_481)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1618 * (var_1128 - var_767)) + var_767;
      }
   }
}
