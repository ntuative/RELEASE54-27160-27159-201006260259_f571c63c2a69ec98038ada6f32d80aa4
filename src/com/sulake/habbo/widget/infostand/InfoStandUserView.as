package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_1013 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_247 = _window.getListItemByName("info_border") as IBorderWindow;
         ...
         if(var_247 != null)
         {
            var_112 = var_247.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_247.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_247.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_247.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_247.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_122.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_122.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_122.x = _loc5_.left - 0;
         var_122.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_112.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_112.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_112.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_112 == null || var_247 == null || var_65 == null)
         {
            return;
         }
         var_65.width = var_65.scrollableRegion.width;
         var_112.height = var_112.scrollableRegion.height;
         var_247.height = NaN;
         _window.width = Math.max(var_247.width,var_65.width);
      ...
      {
         var _loc2_:ITextWindow = var_112.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_112.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_112.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_112.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_1013.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_112.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_112.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_112.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_122 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_122 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_976:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_831:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_122.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_122.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_122.x = _loc7_.left - 0;
         var_122.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_112.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_112.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = var_112.getListItemByName("image_and_badges_container") as IWindowContainer;
