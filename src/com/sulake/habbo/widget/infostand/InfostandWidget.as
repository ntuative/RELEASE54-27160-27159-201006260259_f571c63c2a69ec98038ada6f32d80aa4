package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1475:String = "infostand_user_view";
      
      private var var_336:InfoStandPetView;
      
      private var var_1327:InfoStandPetData;
      
      private var var_143:Timer;
      
      private var var_981:InfoStandFurniView;
      
      private var var_470:InfostandFurniData;
      
      private var var_386:InfoStandBotView;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_981 = new InfoStandFurniView(this,const_1474);
         var_219 = new InfoStandUserView(this,const_1475);
         var_336 = new InfoStandPetView(this,const_1477);
         var_386 = new InfoStandBotView(this,const_1476);
         var_448 = new InfostandUserData();
         var_470 = new InfostandFurniData();
         var_1327 = new InfoStandPetData();
         var_143 = new Timer(const_1746);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_219.setTags(param1.tags,var_2257);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_284,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_670,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_427,var_336.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_284,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_670,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_386.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_130:
               _loc2_ = param1.id == var_470.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_284:
               ...
               {
                  _loc2_ = param1.id == var_1327.roomIndex;
                  break;
               }
               if(var_386 != null && false && var_386.window.visible)
               {
                  _loc2_ = param1.id == var_448.userRoomId;
                  break;
               }
