package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1731:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1729:String = "level";
      
      private var var_112:IItemListWindow;
      
      private const const_1733:String = "energy";
      
      private var var_1327:Map;
      
      private const const_1735:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1737:uint = 3355443;
      
      private var var_247:IBorderWindow;
      
      private const const_1732:int = 158;
      
      private const const_1736:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_185:PetCommandTool;
      
      private const const_1730:uint = 11184810;
      
      private const const_1734:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_247.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_247.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_112.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_112.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_185 == null)
         {
            var_185 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1327.getValue(var_602) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_185.showWindow(true);
            var_185.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_112.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_112.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1729,param1.level,param1.levelMax);
         updateStateElement(const_1734,param1.experience,param1.experienceMax);
         updateStateElement(const_1733,param1.energy,param1.energyMax);
         updateStateElement(const_1735,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_602 = param1.id;
         var_1327.remove(param1.id);
         var_1327.add(param1.id,param1);
         if(var_185 && var_185.isVisible() && param1.isOwnPet)
         {
            var_185.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_112.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_185.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_185 && var_185.getPetId() == var_602)
               {
                  var_185.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_489,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1732,const_1736,false);
