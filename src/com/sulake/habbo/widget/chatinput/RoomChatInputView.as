package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_519:int = 16;
      
      private static const const_1070:int = 20;
      
      private static const const_364:int = 10;
      
      private static const const_1069:int = 40;
      ...
      private var var_408:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1045 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1805 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1806 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_706 = new Timer(1000,1);
         var_706.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_851 = new Timer(5000,1);
         var_851.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_133,onInputChanged);
         _window.addEventListener(WindowEvent.const_397,onWindowMoved);
         var_1233 = true;
         var_127 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1804 = _loc2_.width + const_519 + _loc6_.width + const_1070;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1069,_loc8_.width) + const_519);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1045 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_127 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_408);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_408);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_489);
