package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_56 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_56 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_51 = var_56.findChildByName("user_list") as IItemListWindow;
         var_56.visible = false;
