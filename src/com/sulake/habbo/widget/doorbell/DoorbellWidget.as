package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_760,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_127,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_50,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_760,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_127,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_50,onDoorbellHandled);
      }
