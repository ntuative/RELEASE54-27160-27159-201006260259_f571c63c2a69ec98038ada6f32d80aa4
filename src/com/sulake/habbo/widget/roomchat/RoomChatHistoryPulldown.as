package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_795:int = 150;
      
      private static const const_794:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_40 = param3;
         var_2007 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1587 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2008 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1586 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1588 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2004 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2005 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_73 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_36,HabboWindowParam.const_69,new Rectangle(0,0,param3.width,param3.height - const_73),null,0,0) as IBitmapWrapperWindow;
         ...
         var_105 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_398,HabboWindowStyle.const_34,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_73),null,0) as IRegionWindow;
         if(var_105 != null)
         {
            var_105.background = true;
            var_105.mouseTreshold = 0;
            var_105.addEventListener(WindowMouseEvent.const_49,onPulldownMouseDown);
            var_40.addChild(var_105);
            var_105.toolTipCaption = "${chat.history.drag.tooltip}";
            var_105.toolTipDelay = 250;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_490:
               var_73.blend += param1 / const_794;
               _window.blend += param1 / const_794;
               if(false)
               {
                  state = const_302;
               }
               break;
            case const_817:
               var_73.blend = 0 - param1 / const_795;
               _window.blend = 0 - param1 / const_795;
               if(true)
               {
                  state = const_197;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_105.x = 0;
            var_105.y = 0 - const_73;
            var_105.width = 0 - var_2006;
         }
         if(var_73 != null)
         {
            var_73.rectangle = var_40.rectangle;
            var_73.height = 0 - const_73;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2009 == _window.width)
         {
            return;
         }
         var_2009 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2007.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1587.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1587.clone(),_loc9_);
