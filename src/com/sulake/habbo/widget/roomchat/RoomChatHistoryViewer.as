package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1108:int = 18;
      ...
      private var var_369:Number = 1;
      
      private var _widget:RoomChatWidget;
      
      private var var_319:Boolean = false;
      
      private var var_246:Number = -1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_165.state = RoomChatHistoryPulldown.const_197;
         ...
         var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_860,HabboWindowStyle.const_34,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_246 > 0 && param2)
         {
            if(var_1335)
            {
               if(Math.abs(param1 - var_246) <= const_948)
               {
                  return;
               }
               var_1335 = false;
            ...
            if(var_319)
            {
               ...
               _loc5_ = (param1 - var_246) / 0;
               _loc3_ = var_369 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_246;
               _loc7_ = true;
               _loc8_ = true;
               if(var_46.scrollV < 1 - const_1108 / var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1592)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_319 && !var_1354)
         {
            ...
            var_165.state = RoomChatHistoryPulldown.const_302;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_165.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_197);
      }
