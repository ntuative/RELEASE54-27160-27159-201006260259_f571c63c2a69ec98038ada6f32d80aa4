package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1454:String = "noconvinfo";
      ...
      private var var_1231:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1231 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_870 = IWindowContainer(var_18.content.findChildByName("main_content"));
         var_287 = IWindowContainer(var_18.content.findChildByName("footer"));
         var_1231.prepare(var_870);
         var_18.procedure = onWindow;
         var_18.content.setParamFlag(HabboWindowParam.const_964,false);
         var_18.content.setParamFlag(HabboWindowParam.const_1293,true);
         var_18.header.setParamFlag(HabboWindowParam.const_532,false);
         var_18.header.setParamFlag(HabboWindowParam.const_998,true);
         var_18.content.setParamFlag(HabboWindowParam.const_532,false);
         var_18.content.setParamFlag(HabboWindowParam.const_998,true);
         var_18.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1230 = ITextWindow(var_18.findChildByName("info_text"));
         var_1230.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_287.y = Util.getLowestPoint(var_18.content);
         var_287.width = _friendList.tabs.windowWidth;
         ...
         var_18.scaler.setParamFlag(HabboWindowParam.const_851,this._friendList.tabs.findSelectedTab() != null);
         var_18.scaler.setParamFlag(HabboWindowParam.const_532,false);
         var_18.scaler.setParamFlag(HabboWindowParam.const_964,false);
         var_18.scaler.x = 0 - var_18.scaler.width;
         var_18.scaler.y = 0 - var_18.scaler.height;
         var_1510 = var_18.height;
         var_1511 = var_18.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1510 == -1 ? 0 : int(0 - var_1510);
         var _loc4_:int = var_1511 == -1 ? 0 : int(0 - var_1511);
