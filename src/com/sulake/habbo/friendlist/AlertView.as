package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1219));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1502[var_1219]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
