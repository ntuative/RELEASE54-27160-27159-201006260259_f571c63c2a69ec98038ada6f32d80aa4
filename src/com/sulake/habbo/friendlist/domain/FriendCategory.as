package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_245.length / const_321);
      }
      ...
      {
         if(this.var_916 >= this.getPageCount())
         {
            this.var_916 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_916 + 1) * const_321,this.var_245.length);
      }
