package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_141:String = "face";
      ...
      private var var_1583:OpenedToWebPopup;
      
      private var var_850:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_435:FriendListTabs;
      ...
      private var var_1584:AvatarSearchResults;
      ...
      private var var_2002:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_912:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2002 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1584 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_435.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_94.addCategory(new FriendCategory(FriendCategory.const_861,getText("friendlist.friends")));
         var_94.addCategory(new FriendCategory(FriendCategory.const_453,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_94.addFriend(new Friend(_loc4_));
         }
         var_435 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_535)
         {
            var_535 = new Timer(120000);
            var_535.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_535.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_535.stop();
            var_535.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_535 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_850)
         {
            var_850.release(new IIDAvatarRenderManager());
            var_850 = null;
         }
         if(var_912)
         {
            var_912.release(new IIDHabboNotifications());
            var_912 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_640)
         {
            var_640.release(new IIDSessionDataManager());
            var_640 = null;
         }
         super.dispose();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = var_94.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_141) as IBitmapWrapperWindow;
      ...
      {
         var_94.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_135.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_435.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1584.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_94.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_640.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_640.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_435.findTab(FriendListTab.const_83);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_850.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_40);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_435.findTab(FriendListTab.const_83);
      ...
      {
         return var_135.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1583 == null)
         {
            var_1583 = new OpenedToWebPopup(this);
         }
         var_1583.show(x,y);
      }
