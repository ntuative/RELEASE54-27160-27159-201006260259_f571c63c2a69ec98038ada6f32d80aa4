package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_593:
               ...
               break;
            case RoomWidgetWaveMessage.const_725:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_716:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_638:
               if(var_14 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_720:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_557:
               if(var_14 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_601:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_943)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_244,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_534:
               ...
               if(var_14 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1040:
                        _catalog.openCatalogPage(CatalogPageName.const_1300,true);
                        break;
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1350:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1417:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_747:
            case RoomWidgetStopEffectMessage.const_589:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_975:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1008:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_756:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_613:
               ...
               if(_toolbar)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_14 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_708:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_382,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_346:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_394));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_654:
            ...
            case RoomWidgetAvatarEditorMessage.const_637:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_345:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_633));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_413:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_431));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_549,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_413,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_549,onFigureUpdate);
         ...
         if(var_14 != null)
         {
            (var_14 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1034,onAvatarEffectsChanged);
            (var_14 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_899,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_413,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_725);
         _loc1_.push(RoomWidgetDanceMessage.const_716);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_638);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_720);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_557);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_747);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_534);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_601);
         _loc1_.push(RoomWidgetStopEffectMessage.const_589);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1398);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1008);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_967);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_756);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_593);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_654);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1435);
         ...
         _loc1_.push(RoomWidgetClothingChangeMessage.const_345);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_763));
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(false)
         {
            ...
            if(_loc3_ != var_1454)
            {
               ...
               _loc5_ = _container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_46,_loc4_,this);
               if(_loc5_ != null)
               {
                  _loc5_.setDirection(AvatarSetType.const_40,3);
