package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_301;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_746);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_714);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_594);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_138:
               ...
               break;
            case FriendRequestEvent.const_50:
            case FriendRequestEvent.const_256:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_746:
            ...
            case RoomWidgetFriendRequestMessage.const_714:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_594:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_138);
         _loc1_.push(FriendRequestEvent.const_50);
         _loc1_.push(FriendRequestEvent.const_256);
         return _loc1_;
      }
