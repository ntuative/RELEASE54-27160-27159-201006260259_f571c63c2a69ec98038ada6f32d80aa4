package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_92:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_262:
               _container.events.dispatchEvent(param1);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_390);
         _loc1_.push(AdEvent.const_487);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_92);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_262);
         return _loc1_;
      }
