package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2396:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1717:ILogger;
      
      private var var_1480:String;
      
      private var var_2394:String;
      
      private const const_1480:String = "fuselogin";
      
      private var var_331:ICoreCommunicationManager;
      
      private var var_474:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2395)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_832 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_832);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,var_1480,var_2394));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1480,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_474.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_474.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2396);
      ...
      {
         var_832 = _habboConfiguration.getKey("sso.ticket",null);
         var_1480 = _habboConfiguration.getKey("flash.client.url","");
         var_2394 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_193 == null)
         {
         ...
         if(var_832 != null)
         {
            var_64.mode = HabboConnectionType.const_497;
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_755);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2396 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_497:
               _loc6_ = "";
               ...
               var_1191 = _loc4_;
               var_193.loadBannerImage(_loc7_ + "?token=" + var_1191,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_936:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1304:
               var_686 = generateRandomHexString(30);
               var_474 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_474.init(var_686);
               _loc8_ = var_474.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1191);
         ...
         var_474 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_474.init(_loc14_);
            _loc15_ = var_474.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_936;
            }
         }
         var_64.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_241);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionEvent.const_107,onRoomSessionEnded);
      }
