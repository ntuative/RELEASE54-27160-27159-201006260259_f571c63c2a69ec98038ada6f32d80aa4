package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_647:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_192.shockwaveClientUrl = var_124.shockwaveClientUrl;
         var_192.ssoTicket = var_124.ticket;
         var_124.removeEventListener(SSOTicket.const_343,onParsedTicketSuccess);
         var_124.removeEventListener(SSOTicket.const_289,onParsedTicketFailure);
         var_124 = null;
         dispatchEvent(new Event(const_647));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1480,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_192.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_108,HabboWindowStyle.const_34,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1480,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_192.habboConfiguration.getKey("use.sso","false") == "true")
            {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_124 = new SSOTicket(var_192.assets,_loc2_,_loc1_);
         var_124.addEventListener(SSOTicket.const_343,onParsedTicketSuccess);
         var_124.addEventListener(SSOTicket.const_289,onParsedTicketFailure);
      }
