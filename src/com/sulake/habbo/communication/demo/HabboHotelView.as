package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_609:Function;
      
      private var _window:IWindowContainer;
      
      private var var_710:IAssetLibrary;
      
      private var var_859:uint = 0;
      
      private var var_608:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_710.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_471));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_710.loadAssetFromFile("hotel_view_banner_" + var_859,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_764));
            }
            var_608 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_710.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
