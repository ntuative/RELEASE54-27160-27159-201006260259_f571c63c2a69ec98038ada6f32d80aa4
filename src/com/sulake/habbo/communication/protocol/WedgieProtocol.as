package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1211:uint = 2;
       
      
      private var var_932:IProtocolDecoder;
      
      private var var_1116:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1116 = new WedgieEncoder();
         var_932 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1230)
            {
               _loc4_.position = 0;
               _loc6_ = var_932.getID(_loc4_);
